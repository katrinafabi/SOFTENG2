    ...
    <section id="for100vh">
        <div id="aboutsection">
            ...
            <div class="importantcontainer">
                <div class="dropdown">
                <a class="importantcontaineractive" href="dashboard-denied.php">
                    <button class="dropdown-toggle">DENIED</button>
                </a>
                    <div class="dropdown-content">
                    <a class="importantcontainernotactive" href="dashboard.php">REQUESTS</a>
            ...
            <table>
                ...
                <tbody id="tableBody">
                    <?php include 'phpexecution/fetchuser_activity-denied.php'; ?>
                    <tr id="noResultRow" style="display: none;">
                        <td colspan="6">No result for <span class="thesearch" id="searchQuery"></span></td>
                    </tr>
                </tbody>
            </table>
            </div>
