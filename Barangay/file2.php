...
<body>
    <section id="for100vh">
        ...
        <div id="aboutsection">
            ...
            <div id="inp1">
                <h1>First Time Job Seeker</h1>
                <input type="hidden" id="title" name="title" value="First Time Job Seeker">
            ...
            <div id="inp1">
                <div id="inp1label">
                    ...
                    <input type="date" readonly id="dob" name="dob" value="<?php echo $user['birthdate']?>" required>
                </div>

                <div id="inp23label">
                    <label for="age">Age</label>
                    <input type="number" id="age" readonly name="age" placeholder="Age" value="" required>
                </div>
            </div>
            ...
            <input type="hidden" id="sb_name" name="sb_name" placeholder="e.g. Sv Store" value="">
