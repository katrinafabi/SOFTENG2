    ...
    <section id="for100vh">
        <div id="aboutsection">
                ...
                <button class="notification-toggle"><img src="css/pictures/dashboard/notification.svg" alt="bell"></button>
                    <div class="notification-container">
                        <div class="notification-list" id="notificationList">
                            <p style="padding: 20px; text-align:center;">No notification yet!</p>
                        </div>
                    </div>
            </div>
            ...
            <div class="importantcontainer">
                <div class="dropdown">
                <a class="importantcontaineractive" href="dashboard-completed.php">
                    <button class="dropdown-toggle">COMPLETED</button>
                </a>
                    <div class="dropdown-content">
                        <a class="importantcontainernotactive" href="dashboard.html">REQUESTS</a>
