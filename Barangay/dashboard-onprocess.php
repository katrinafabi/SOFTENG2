    ...
    <section id="for100vh">
        <div id="aboutsection">
            ...
            <div class="importantcontainer">
                <div class="dropdown">
                <a class="importantcontaineractive" href="dashboard-onprocess.php">
                    <button class="dropdown-toggle">ONGOING</button>
                </a>
            ...
            <table>
                ...
                <tbody id="tableBody">
                    <?php include 'phpexecution/fetchuser_activity-onprocess.php'; ?>
                    <tr id="noResultRow" style="display: none;">
                        <td colspan="4">No result for <span class="thesearch" id="searchQuery"></span></td>
                    </tr>
                </tbody>
            </table>
            </div>
