...
<body>
    <section id="for100vh">
        ...
        <div id="aboutsection">
            <form id="file1-form" action="phpexecution/filerequest.php" method="POST">
            <h2>REQUEST FORM</h2>
            <p>Fill up all the required details</p>

            <div id="inp1">
                <h1>Barangay Clearance</h1>
                <input type="hidden" id="title" name="title" value="Barangay Clearance">
            ...
            <div id="inp1">
                <div id="inp1label">
                    ...
                    <textarea name="address" id="address" readonly><?php echo $user['address'];?></textarea>
                </div>
            </div>
