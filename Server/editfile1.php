...
<body>
            ...
            <form id="file1-form" action="phpexecution/completerequest.php" method="POST">
                ...
                <div id="inp1">
                    <div id="inp1label">
                        ...
                        <input type="text" readonly id="fullname" name="fullname" placeholder="First name/Middle initial/Last name" value="<?php echo htmlspecialchars($name); ?>" required>
                    </div>
                ...
                <div id="inp1">
                    ...
                    <button type="button" style="background-color: rgb(0, 81, 69);" onclick="confirmUpdate()">COMPLETE REQUEST</button>
                </div>
    ...
    <div id="overlay">
        <div id="reasonSelect">
            ...
            <button style="padding:8px; background-color:green; color:white;" onclick="submitDenyReason()">Submit</button>
