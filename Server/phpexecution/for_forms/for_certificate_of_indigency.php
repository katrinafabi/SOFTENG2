...
<body>
    <section class="certification">
        ...
        <p>This is to certify that <strong><?php echo htmlspecialchars($name); ?></strong> comes from an Indigent Family.</p>
        ...
        <div class="signature">
            <div class="insidesignature">
                <p style="margin-top:90px;"><strong>JUDE TUCIONE L. GARCIA</strong></p>
                <p>Punong Barangay</p>
            </div>
        </div>
