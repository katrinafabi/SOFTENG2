        ...
        <div id="aboutsection">
            ...
            <div class="importantcontainer">
                <div class="importanta">
                    ...
                    <a class="importantcontaineractive" href="server-dashboard-pickup.php">SCHEDULED</a>
            ...
            <table>
                <thead>
                    ...
                    <tbody id="tableBody">
                        <?php include 'phpexecution/fetchuser_activity-pickup.php'; ?>
