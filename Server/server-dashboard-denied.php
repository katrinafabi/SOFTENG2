        ...
        <div id="aboutsection">
            ...
            <div class="importantcontainer">
                <div class="importanta">
                    ...
                    <a class="importantcontaineractive" href="server-dashboard-denied.php">DENIED</a>
                    <a class="importantcontainernotactive" href="server-dashboard-pickup.php">SCHEDULED</a>
                    <a class="importantcontainernotactive" href="server-dashboard-completed.php">COMPLETED</a>
                </div>
